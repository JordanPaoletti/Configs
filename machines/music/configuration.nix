...

{
  ...
  boot.initrd.luks.devices."luks-9520f2bc-5218-416c-b637-6e3ec528f6de".device =
    "/dev/disk/by-uuid/9520f2bc-5218-416c-b637-6e3ec528f6de";
  networking.hostName = "music"; # Define your hostname.
